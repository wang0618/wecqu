...
Page({
    data: {
        ...
        timetable: [
            ...
            {min: 1075, max: 1150, data: ['18:50', '18:55', '19:00', '19:10', '18:05', '17:57', '17:55']},
            {min: 1160, max: 1210, data: ['19:50', '19:55', '20:00', '20:10', '19:30', '19:22', '19:20']},
        ...
        msg: [
            '1、本时刻表为8月31日至期末考试前时刻表，将根据交通实际情况进行调整。',
            '2、8:30、10:00、12:00、15:30、17:50、18:50、21:15从老校区到虎溪校区的班次增加停靠虎溪花园北、南站、理科大楼。',
